...
export default function PrayerRequestPage() {
    ...
    if (success) {
        return (
            <InternalPageLayout
                ...
                subtitle="Envie seu pedido e nós vamos orar com você."
                icon={Heart}
                iconClassName="text-rose-500"
                backPath="/home"
            >
                <div className="flex flex-col items-center justify-center min-h-[40vh] text-center animate-in fade-in duration-500 p-4">
    ...
    return (
        <InternalPageLayout
            ...
            backPath="/home"
        >
            <div className="max-w-2xl mx-auto px-4 pb-8 animate-in slide-in-from-bottom-4 duration-500">
