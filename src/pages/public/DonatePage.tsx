...
const DonatePage: React.FC = () => {
    ...
    return (
        <>
            <SEOHead />
            <div className="min-h-screen bg-gradient-to-b from-purple-50 via-white to-white pt-20 pb-24 px-4 animate-in fade-in duration-500 max-w-md mx-auto px-4 pt-6">
