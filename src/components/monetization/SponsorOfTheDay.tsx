        ...
        <>
            <div className="animate-fade-in-up delay-100">
                <div className="flex items-center gap-2 mb-3 px-1">
                    ...
                    <span className="text-xs font-bold text-slate-400 uppercase tracking-wider">Patrocinado por</span>
                </div>
                ...
                >
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0 py-1">
                            ...
                            <p className="text-sm text-slate-500 truncate mt-0.5">{sponsor.tagline}</p>
                        </div>
                        <div className="pl-2">
