                ...
                <div className="relative z-10">
                    <div className="flex items-start space-x-3">
                        ...
                        <div className="flex-1">
                            <h3 className="font-heading font-bold text-slate-800 text-sm mb-1">Apoie o Projeto</h3>
                            <p className="text-xs text-slate-500 leading-relaxed mb-3">
                                Tecnologia a serviço do Reino. Sua contribuição ajuda a manter e evoluir o MD Connect.
                            </p>
                            ...
                            <div className="flex flex-col sm:flex-row sm:items-center gap-3">
                                <button
                                    onClick={() => {
                                        ...
                                        window.open('https://wa.me/?text=Quero%20contribuir%20com%20o%20projeto', '_blank');
                                    }}
                                ...
                                >
                                    ...
                                    <span className="font-medium">Parceria com Igrejas</span>
                                </button>
                            </div>
                        </div>
                    </div>
