...
export function PublicHeader({ church }: PublicHeaderProps) {
        ...
        <header className="sticky top-0 z-20 py-4 px-5 flex items-center justify-between bg-white/70 backdrop-blur-xl border-b border-white/40 shadow-sm transition-all duration-300">
            ...
            <div className="flex items-center gap-2">
                ...
                <button
                    ...
                    className="w-8 h-8 rounded-full bg-slate-100 hover:bg-slate-200 flex items-center justify-center text-slate-400 transition-colors border border-slate-200 hidden sm:flex"
                >
                    {reducedMotion ? (
                ...
                {user ? (
                    ...
                    <button
                        ...
                        aria-disabled="true"
                        title="Em breve"
                        className="w-10 h-10 rounded-full bg-white/50 border border-white/60 flex items-center justify-center text-[#4F46E5] opacity-50 cursor-not-allowed shadow-sm"
                    >
